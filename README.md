# 🔥 Firefly (Beta Version)
**Beta v1.0**
A self-hosted media server for movies and TV shows, built with Flask.
...
ff = Firefly(debug=True, tmdbv3api_key="YOUR_API_KEY", clientPassword="YOUR_PASSWORD")
